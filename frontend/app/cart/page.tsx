...
import { Trash2, Plus, Minus, CreditCard, Loader2, CheckCircle2, ShoppingCart } from 'lucide-react';
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-[#FF5C00]/5">
        ...
        >
          ...
          <p className="text-gray-500 text-lg mb-10">
            Thank you for choosing Foodio. Your order is being prepared and will be with you shortly.
          </p>
          <div className="flex flex-col gap-4">
            <button onClick={() => router.push('/orders')} className="btn-primary py-4 text-lg">
              Track My Order
            </button>
            <button onClick={() => router.push('/')} className="text-[#FF5C00] font-bold">
              Back to Menu
            </button>
          </div>
        </motion.div>
      ...
      <main className="flex-grow max-w-7xl mx-auto w-full px-6 py-12">
        ...
        {items.length === 0 ? (
          <div className="text-center py-24 bg-white rounded-[3rem] premium-shadow">
            ...
            <p className="text-gray-500 mb-8">Add something delicious from our menu.</p>
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-[#FF5C00] font-bold">${item.price.toFixed(2)}</p>
                    </div>
                    <div className="flex items-center gap-4 bg-gray-50 p-2 rounded-2xl">
                      <button onClick={() => updateQuantity(item.id, -1)} className="p-1 hover:text-[#FF5C00]">
            ...
            <div className="bg-white p-8 rounded-[3rem] premium-shadow h-fit sticky top-32">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between text-xl font-black">
                  <span>Total</span>
                  <span className="text-[#FF5C00]">${(total + 2).toFixed(2)}</span>
                </div>
              </div>
              <button 
