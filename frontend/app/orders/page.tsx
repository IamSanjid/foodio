              ...
              >
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-1">
                      <span className="font-black text-xl">Order #{order.id}</span>
                      <span className={`text-xs font-bold px-3 py-1 rounded-full uppercase tracking-tighter ${getStatusColor(order.status)}`}>
                        {order.status}
                      </span>
                    </div>
                ...
                <div className="flex items-center gap-12">
                  <div className="text-right">
                    ...
                    <p className="text-2xl font-black text-[#FF5C00]">${Number(order.totalAmount).toFixed(2)}</p>
                  </div>
